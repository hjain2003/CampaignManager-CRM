        ...
        <div className="filter_section">
          ...
          <div className="filter_item">
            ...
            <div className="slider_marks">
              {[MIN, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, MAX].map(
                (value) => (
          ...
          <button onClick={openCreateBox}>Create Campaign ({customers.length})</button>
        </div>
